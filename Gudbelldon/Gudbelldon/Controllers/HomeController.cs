        ...
        public async Task<ActionResult> Index()
        {
            ...
            var model = new HomeModel
            {
                ...
                Events = new List<Event> {
                    ...
                    new Event(null, "Filzhasen", null, " Kursbeitrag € 9,-", new DateTime(2017,03,13), new TimeSpan(18,30,0), null),
                    new Event(null, "Filzkörbe", null, " Kursbeitrag € 9,-", new DateTime(2017,03,20), new TimeSpan(18,30,0), null),
                    new Event(null, "Hühner stricken", null, " Kursbeitrag € 9,-", new DateTime(2017,03,27), new TimeSpan(18,30,0), null),
                    new Event(null, "Fühlingsdeko häkeln", null, " Kursbeitrag € 9,-", new DateTime(2017,4,3), new TimeSpan(18,30,0), null),
                ...
                KnittingDates = new List<KnittingNight> {
                    ...
                    new KnittingNight(new DateTime(2017,6,13), "grade", "#eea159", "Cafe/Konditorei Hubertus ab 18 Uhr"),
                    new KnittingNight(new DateTime(2017,6,20)),
                    new KnittingNight(new DateTime(2017,7,4)),
                    new KnittingNight(new DateTime(2017,7,12), "grade", "#eea159", "Bockauwirt"),
                    new KnittingNight(new DateTime(2017,7,12), "Strickabend - Sommerpause"),
                    new KnittingNight(new DateTime(2017,8,21), "grade", "#eea159", "Foxis Schlosstaverne"),
                    new KnittingNight(new DateTime(2017,8,29)),
                    new KnittingNight(new DateTime(2017,9,5)),
                    new KnittingNight(new DateTime(2017,9,19)),
                    new KnittingNight(new DateTime(2017,9,26), "grade", "#eea159", "Strickfrühstück / Freistil ab 9 Uhr"),
                    new KnittingNight(new DateTime(2017,10,3)),
                    new KnittingNight(new DateTime(2017,10,10)),
                    new KnittingNight(new DateTime(2017,10,18), "grade", "#eea159", "Stitch & Bitch im MÜK ab 9:30 Uhr"),
                    new KnittingNight(new DateTime(2017,10,24)),
                    new KnittingNight(new DateTime(2017,11,7)),
                    new KnittingNight(new DateTime(2017,11,14), "grade", "#eea159", "Ratsherrnstube"),
                    ...
                    new KnittingNight(new DateTime(2017,12,12), "grade", "#eea159", "Vis a Vis"),
